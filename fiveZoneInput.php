        ...
        <div id="parainput" class="">
        	...
        	<form id="parametricform" class="pure-form" method="POST" style="font-size:0.9em">
				...
				<div class="item">
					...
					<label>
						First Value
						<input name="lbybratio[]" value="0.5" min="0.5" max="5.0" step="any" type="number">
					</label><br>
					<label>
						Second Value
						<input name="lbybratio[]" value="1.0" min="0.1" max="5.0" step="any" type="number">
					</label><br>
					<label>
						Third Value
						<input name="lbybratio[]" value="1.5" min="0.1" max="5.0" step="any" type="number">
					</label><br>
					<label>
						Fourth Value
						<input name="lbybratio[]" value="2.0" min="0.1" max="5.0" step="any" type="number">
					</label><br>
					<label>
						Fifth Value
