...
$itme34=array();         
    $count=0;
            ...
            if($var_quantities[0]=='1'){
             ...
             if($var_quantities[1]=='1'){
                ...
                if($var_quantities[1]=='2'){
                                $str=$str.",North_WWR:$item3[$i]";
                                $str=$str.",South_WWR:$item32[$i]";
                                $str=$str.",East_WWR:$item33[$i]";
                                $str=$str.",West_WWR:$item34[$i]";
                }
      ...
      <div id="main">
         ...
         <div id="parallel"></div>
         <div id="myGrid" style="postition:relative;left:10%;height:1000px" ></div>
         <script type="text/javascript">
            ...
            function myFunction()
            {
                setInterval(function(){didit();},3000);
            }
            myFunction();
            ...
            var superhighlight=null;
            var superfilter=null;
      ...
      <?php
         ...
         if (file_exists($filename)) 
         {
            ...
            echo("<meta http-equiv=\"refresh\" content=\"10;URL=displaygenopt.php?unique_counter=".$unique_counter."&var_quantities=".$var_quantities."\">");
         }
