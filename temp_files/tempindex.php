...
var address2="./mydisplay.php?unique_counter="+unique_counter+"&var_quantities="+str;
//alert(address2);
...
<div id="id0" style="height:800px;margin-top: -20px;">

<div id="id1" style="background-color: #014051;height:100%;width:1300px;float:left;padding: 10px;">


<table border=1 style="width: 100%; text-align: left; margin-right: auto;">
<tbody>
<tr>
...
Window Optimization Tool </h1>
</td>
</tr>
</tbody>
</table>
<form id="frm1" name="data" action="#" method="post">
...
<table border=1 style="width: 100%;text-align: left; margin-left: auto; margin-right: auto; background-color:#0099ac">
<tbody>
...
<td style="width: 41px;"><br>
</td>
<td style="vertical-align: top; background-color: #5737b2; color: white;">
<table border=1 style="width: 100%; text-align: left; margin-left: auto; margin-right: auto; background-color:#5737b2;">
<tbody>
<tr>
...
checked="checked" type="radio">Variabe</td>
</tr>
</tbody>
</table>
<div id="wwrvariable"> <br>
<table border=1 style="width: 100%;">
<tbody>
<tr>
<td>Initial Value </td>
...
<div id="wwrfixed" style="display: none;"> <br>
...
<table border=1 style="width: 100%; text-align: left; margin-left: auto; margin-right: auto; background-color:#da542e">
<tbody>
<tr>
...
<table border=1 style="width: 100% ; background-color:#bf1f4b;">
<tbody>
...
<table border=1 style="width: 100%;background-color:#009f00">
<tbody>
<tr>
...
<table border=1 style="width: 100%; background-color: #a101a8; height: 35px;">
<tbody>
<tr>
...
<tbody>
<tr>
<td style="background-color: rgb(0, 51, 0);color:white">
	<input id="non_parametric" style="" checked="checked"
value="perform_parametric_simulation" type="checkbox">Perform Parametric Optimization
	<input style="float:right; height:30px; width:70px;"
...
<h4 style="color:white">Select Your Location</h4>
...
<td style="width: 100%; margin-top: -5px; text-align: center; vertical-align: middle; background-color: black;">
<h1 class="a0" style="height: 26px; background-color: black;">WinOpt -
Window Optimization Tool ( Parametric )</h1>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td style="background-color: rgb(0, 51, 0);"><input style="float:right; height:30px; width:70px background-color:#FF00FF;"
value="submit" type="submit"> <br>
<br>
</td>
</tr>
...
<div id="id3" style="height:100%;width:1300px;float:left;margin-top: 20px;"><iframe id="iframe2" src="./mydisplay.php?unique_counter=a57dedcc-3975-a896-cb7f-ab0eee901e7d&amp;var_quantities=11111" style="width:100%;height:100%"></iframe></div>
<a href="#id4" style="float:left;margin-top:30px">fourth</a>

<div id="id4" style="height:100%;width:1300px;float:left;margin-top: 20px;"><iframe id="iframe1" src="./displayparametric.php?unique_counter=f392a91b-564d-6aca-8c66-f14a7b6eb8b3/" style="width:100%;height:100%"></iframe></div>
