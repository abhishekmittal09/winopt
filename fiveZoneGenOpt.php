				<div id="genoptformdiv">
					<div class="item pure-form-stacked">
						...
						Plot Length (meter)<input type="text" name="total_length" value="50"><br>
						Plot Width (meter)<input type="text" name="total_breadth" value="30"><br>
						Building Thickness (meter)<input type="text" name="building_thickness" value="6"><br>
						Building Height (meter)<input type="text" name="building_height" value="4"><br>
						Building Area (square meter)<input id="total_area" type="text" name="total_area" value="50"><br>
					</div>
					<div class="item">
					...
					<div class="item">
						...
						<div id="wwrvariable" style="display:none;">
							<label style="float: left;">
								<input name="diff_wwr" id="diff_wwr" style="" type="checkbox">
