				...
				<div class="item">
					...
					<label>
						Initial Value
						<input name="depth_ini_value" value="0.5" min="0.1"
											max="3.0" step="any" type="number">
					</label><br>
					<label>
						Minimum Value
					...
					<label>
						Maximum Value
						<input name="depth_max_value" value="1" min="0.1"
											max="3.0" step="any" type="number">
					</label><br>
					<label>
						Step Value
						<input name="depth_step_value" value="0.1" min="0.1"
											max="3.0" step="any" type="number">	
					</label><br>
				</div>
